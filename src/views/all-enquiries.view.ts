...
import { ENQUIRY_UNIVERSAL_IDENTIFIER, ENQUIRY_NUMBER_FIELD, ENQUIRY_SOURCE_DETAIL_FIELD, ENQUIRY_TYPE_FIELD, ENQUIRY_STATUS_DETAIL_FIELD, ENQUIRY_BUDGET_FIELD } from '../objects/enquiry.object';
...
export default defineView({
  ...
  fields: [
    ...
    { universalIdentifier: '0bb31790-fc39-4835-b14f-bc4d20495215', fieldMetadataUniversalIdentifier: ENQUIRY_SOURCE_DETAIL_FIELD, position: 1, isVisible: true },
    ...
    { universalIdentifier: 'cc901f51-6664-4bee-aa09-1f6dc8788ba4', fieldMetadataUniversalIdentifier: ENQUIRY_STATUS_DETAIL_FIELD, position: 3, isVisible: true },
