...
import { SELLER_UNIVERSAL_IDENTIFIER, SELLER_NAME_FIELD, SELLER_STAGE_FIELD, SELLER_EXPECTED_PRICE_FIELD, SELLER_TIMELINE_FIELD, SELLER_PROPERTY_ADDRESS_FIELD, SELLER_MOTIVATION_FIELD, SELLER_IS_OWNER_FIELD } from '../objects/seller.object';
